...
export default function Navbar() {
    ...
    return (
        <header>
            ...
            >
                <Link href='/' className="flex items-center gap-3" aria-label="Anthony Salles - Retour à l'accueil">
                    <Image src='/logo.png' alt="" className='size-10 object-contain rounded-full' width={40} height={40} />
                ...
                >
                    <FontAwesomeIcon icon={faBars} className='size-6.5' aria-hidden="true" />
                </button>
            </motion.nav>
