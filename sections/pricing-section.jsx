    ...
    const pricingData = [
        {
            ...
            price: "45€",
            duration: "45 minutes",
            description: "Séance spécifique de thérapie viscérale pour le soulagement des tensions internes.",
            details: [
        ...
        },
        {
            ...
            description: "Soins conventionnés de masso-kinésithérapie et méthodes de chaînes musculaires GDS.",
            details: [
        ...
        <section className="py-24 md:py-32 max-w-6xl mx-auto px-6 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 max-w-4xl mx-auto">
                {pricingData.map((item, index) => (
                    <motion.div
                        key={index}
                        className={`relative p-8 rounded-3xl border transition-all duration-500 overflow-hidden ${item.highlight
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <div className={`size-14 rounded-2xl flex items-center justify-center text-2xl ${item.highlight ? "bg-blue-600 text-white" : "bg-blue-50 text-blue-600"
                                }`}>
                            ...
                            <div className="flex items-baseline gap-2">
                                ...
                                {item.extra && (
                                    <span className="text-blue-600 font-semibold text-sm">{item.extra}</span>
                                )}
                            </div>
                            ...
                            <div className="pt-6">
                                <a
                                    ...
                                    className={`btn w-full py-4 text-center justify-center ${item.highlight ? "bg-blue-600" : "bg-slate-900"
                                        }`}
                                >
                                    Prendre rendez-vous
                                </a>
            ...
            >
                ...
                <div className="space-y-2 text-center md:text-left">
                    <h4 className="font-bold text-slate-900">Remboursements & Sécurité Sociale</h4>
                    <p className="text-slate-600 text-sm leading-relaxed">
                        Les séances de kinésithérapie sont conventionnées. Le remboursement s'effectue sur la base des tarifs de la Sécurité Sociale (60%) et de votre Mutuelle (40%).
                        <br />
                        Le dépassement d'honoraires de 3€ peut être pris en charge par certaines mutuelles (hors CMU/AME).
                    </p>
                </div>
            </motion.div>
        </section>
